            ...
            <div class="overview">
                <div class="title">
                    ...
                    @foreach ($subject as $item)
                        <a href="{{ url('/addstudent', $item->id) }}" class="order">Add Student</a>
                    @endforeach
                ...
                <div class="boxes">
                    ...
                    <div class="box box2">
                        @foreach ($subject as $item)
                            <a href="{{ url('/addactivity', $item->id) }}" class="order">Add Activity</a>
                        @endforeach

                    </div>
                    <div class="box box3">
                        <span class="text">Student submitted</span>
            ...
            <div class="activity">
                ...
                <div class="table">
                    ...
                    <table id="example" class=" data" style="width:100%">
                        ...
                        <tbody>
                            @foreach ($activityforteacher as $item)
                                <tr>
