        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title">
                    ...
                    <a href="{{ route('activity.create') }}" class="order">Order Acrivity</a>
                ...
                <div class="boxes">
                    ...
                    <div class="box box2">
                        <a href="{{ url('subject') }}" class="test1">Course </a>

                    </div>
                    <div class="box box3">
                        <span class="number">Activity 1 </span>
                        <span class="text">Student Name: Firstname Lastname</span>
                        <span class="text">Course: Coures Name 1</span>
                        <span class="text">Location: Location 1 </span>
                        <span class="text">Changes to the way in which ...</span>
                    </div>
            ...
            <div class="subject-boxes">
                ...
                <div class="subject-box box2">
                    <a href="{{ url('subject') }}" class="test1">Course </a>

                </div>
                <div class="subject-box box3">
                    <span class="number">Activity 1 </span>
                    <span class="text">Student Name: Firstname Lastname</span>
                    <span class="text">Course: Coures Name 1</span>
                    <span class="text">Location: Location 1 </span>
